        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark top">
            ...
            <div id="navMainMenu" className="navbar-collapse collapse">
                <div className="navbar-nav ml-auto">
                    ...
                    <Link to='/readAsset' className="nav-item nav-link">readAsset</Link>
                    <Link to='/createAsset' className="nav-item nav-link">Create Asset <strong>Not working now!</strong></Link>
